...
-- 테이블 데이터 dailygram.tbl_favorite:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 dailygram.tbl_feed_comment:~0 rows (대략적) 내보내기
INSERT INTO `tbl_feed_comment` (`commentNo`, `feedNo`, `userId`, `commentContents`, `createAt`) VALUES
	...
	(4, NULL, 'user2@user.com', '댓글 작성', '2024-10-29 16:53:14'),
...
-- 테이블 데이터 dailygram.tbl_feed_img:~12 rows (대략적) 내보내기
...
INSERT INTO `tbl_user` (`userId`, `userPwd`, `userName`, `userNickName`, `userProfilePath`) VALUES
	('user@user.com', '$2b$10$DKgCGNzESECRCHvEbzIeUO7U2HlCqO.DDWUxPjns9wJztn6QLbtVG', '홍길동', '홍홍홍', NULL),
